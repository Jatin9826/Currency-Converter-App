...
def main():
    """
    Entry point for testing currency conversion via command-line.
    Validates arguments and calls the rate conversion function.
    """
    args = sys.argv[1:]
...
def get_rate(from_currency: str, to_currency: str):
    """
    Checks if both currencies are valid and prints the conversion result.
